...
from spid_saml_metadata import *




class SpidOneLogin_Saml2_Settings(object):
    """
    ...
    def get_sp_metadata(self):
        ...
        metadata = SpidOneLogin_Saml2_Metadata.add_x509_key_descriptors(metadata, cert_new, add_encryption)

        cert = self.get_sp_cert()
        metadata = SpidOneLogin_Saml2_Metadata.add_x509_key_descriptors(metadata, cert, add_encryption)
        ...
        if 'signMetadata' in self.__security and self.__security['signMetadata'] is not False:
            ...
            metadata = SpidOneLogin_Saml2_Metadata.sign_metadata(metadata, key_metadata, cert_metadata,
